...
| ID | Requisito | P |
|---|---|---|
| RF6.1 | `![[Desenho.excalidraw.md]]` numa nota renderiza o desenho como SVG, com largura e altura opcionais. | P0 |
...
| RF6.4 | `[[Desenho.excalidraw.md#^idDoElemento]]` numa nota transclui o texto daquele elemento. | P2 |
